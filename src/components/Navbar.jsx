...
const Navbar = () => {
  ...
  return (
    <>
      {/* <button className=":hidden relative top-10 left-64 bg-amber-400 hover:bg-amber-600 text-white font-bold py-2 px-4 rounded">
        Learn for FREE
      </button> */}
      <div className="px-6 py-6 lg:px-8 ">
        <nav className="flex items-center justify-between" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12 text-lg mb-4">
            {navigation.map((item) => (
              <div key={item.name}>
                <Link href={item.href}>
